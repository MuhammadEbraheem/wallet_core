...
class API extends Api {
  ...
  Future<Map<String, dynamic>> _get(String endpoint,
      {bool private, bool isRopsten = false}) async {
    print('GET $endpoint');
    Response response;
  ...
  Future<String> login(String token, String accountAddress, String identifier,
  ...
  Future<dynamic> createWallet({String communityAddress}) async {
    ...
    final dynamic body = communityAddress != null
        ...
        : null;
    Map<String, dynamic> resp =
        await _post('v2/wallets', private: true, body: body);
    if (resp["job"] != null) {
      return resp;
    } else {
  ...
  Future<List<dynamic>> getWalletTransactions(String walletAddress,
  ...
  Future<List<dynamic>> fetchTokenTxByAddress(
      ...
      {String sort = 'desc', int startblock}) async {
  ...
  Future<dynamic> updateFirebaseToken(
      String walletAddress, String firebaseToken) async {
  ...
  Future<dynamic> joinCommunity(
      Web3 web3, String walletAddress, String communityAddress,
      {String tokenAddress,
      String network = 'fuse',
      String originNetwork}) async {
  ...
  Future<dynamic> tokenTransfer(Web3 web3, String walletAddress,
      String tokenAddress, String receiverAddress, num tokensAmount,
  ...
  Future<dynamic> approveTokenTransfer(
      Web3 web3, String walletAddress, String tokenAddress, num tokensAmount,
  ...
  Future<dynamic> trasferDaiToDaiPointsOffChain(
      Web3 web3, String walletAddress, num tokensAmount, int tokenDecimals,
      {String network}) async {
    Map<String, dynamic> data = await web3.trasferDaiToDAIpOffChain(
        walletAddress, tokensAmount, tokenDecimals,
        network: network);
    Map<String, dynamic> resp =
        await _post('v2/relay', private: true, body: data);
    return resp;
  ...
  Future<dynamic> callContract(Web3 web3, String walletAddress,
      String contractAddress, num ethAmount, String data,
      {String network}) async {
    Map<String, dynamic> signedData = await web3.callContractOffChain(
        walletAddress, contractAddress, ethAmount, data,
        network: network);
    Map<String, dynamic> resp =
        await _post('v2/relay', private: true, body: signedData);
    return resp;
  }
  ...
  Future<dynamic> approveTokenAndCallContract(
    ...
    Map<String, dynamic> signedData =
        await web3.approveTokenAndCallContractOffChain(
            walletAddress, tokenAddress, contractAddress, tokensAmount, data,
            network: network);
    Map<String, dynamic> resp =
        await _post('v2/relay', private: true, body: signedData);
    return resp;
  ...
  Future<dynamic> multiRelay(List<dynamic> items) async {
    Map<String, dynamic> resp =
        await _post('v2/relay/multi', private: true, body: {'items': items});
    return resp;
  }

  Future<dynamic> getCommunityData(String communityAddress,
      {bool isRopsten = false, String walletAddress}) async {
    String url = walletAddress != null
        ? 'v1/communities/$communityAddress/$walletAddress'
        : 'v1/communities/$communityAddress';
    Map<String, dynamic> resp =
        await _get(url, private: false, isRopsten: isRopsten);
    return resp['data'];
  }
  ...
  Future<dynamic> updateDisplayName(
    ...
    Map<String, dynamic> resp = await _put('v2/users/$accountAddress/name',
        body: {"displayName": displayName}, private: true);
    return resp;
  }
  ...
  Future<dynamic> createProfile(String communityAddress, Map publicData) async {
    Map<String, dynamic> resp = await _put('v1/profiles/$communityAddress',
        body: {"publicData": publicData}, private: false);
    return resp;
  }

  Future<dynamic> fetchMetadata(String uri, {bool isRopsten = false}) async {
    Map<String, dynamic> resp =
        await _get('v1/metadata/$uri', private: false, isRopsten: isRopsten);
    return resp['data'];
  }
  ...
  Future<dynamic> getFunderJob(String id) async {
    ...
    Response response =
        await funderClient.get(Uri.parse('$_funderBase/job/$id'));
  ...
  Future<dynamic> totleSwap(
    ...
    Map<String, dynamic> signedApprovalData = await web3.approveTokenOffChain(
        walletAddress, tokenAddress, tokensAmount,
        spenderContract: approvalContractAddress, network: network);
    Map<String, dynamic> signedSwapData = await web3.callContractOffChain(
        walletAddress, swapContractAddress, 0, swapData.replaceFirst('0x', ''),
        network: network);
    Map<String, dynamic> resp =
        await multiRelay([signedApprovalData, signedSwapData]);
    return resp;
  }
  ...
  Future<dynamic> transferTokenToHomeWithAMBBridge(
    ...
    List<dynamic> signData = await web3.transferTokenToHome(walletAddress,
        foreignBridgeMediator, tokenAddress, tokensAmount, tokenDecimals,
        network: network);
  ...
  Future<dynamic> transferTokenToForeignWithAMBBridge(
      ...
      int tokenDecimals,
      {String network = 'fuse'}) async {
    List<dynamic> signData = await web3.transferTokenToForeign(walletAddress,
        homeBridgeMediatorAddress, tokenAddress, tokensAmount, tokenDecimals,
        network: network);
    Map<String, dynamic> resp = await multiRelay(signData);
    return resp;
  }
  ...
  Future<dynamic> sellToken(
      ...
      num tokensAmount,
      {String network}) async {
    List<dynamic> signData = await web3.sellToken(reserveContractAddress,
        daiTokenAddress, tokenToApprove, walletAddress, tokensAmount);
    Map<String, dynamic> resp = await multiRelay(signData);
    return resp;
  }
  ...
  Future<dynamic> buyToken(
      ...
      num tokensAmount,
      {String network}) async {
    List<dynamic> signData = await web3.buyToken(reserveContractAddress,
        daiTokenAddress, tokenToApprove, walletAddress, tokensAmount);
    Map<String, dynamic> resp = await multiRelay(signData);
    return resp;
  }
